...
import com.pockectstate.api.common.config.Email_Config;
import com.pockectstate.api.common.model.EmailMsg;
...
public class EmailUtil {
	public static void sendEmail(EmailMsg msg){
		//邮箱
		String myAccount = Email_Config.EMAIL;
		//授权码-不是密码 邮箱规定，第三方平台登录邮箱必须实现授权码
		String myPass = Email_Config.EMAILPASS;
		//邮箱服务器
		String SMTPHost = Email_Config.EMAILHOST;
		//设置属性信息
